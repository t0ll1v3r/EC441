# This lab entailed developing a web server which handles one HTTP request at a time. 
# The web server should accept and parse the HTTP request, get the requested file from the
